  ...
  <main class="flex-shrink-0">
    <div class="container pt-5">
      ...
      <div class="alert alert-light d-flex align-items-center mb-5" role="alert">
        <div>
          <img src="assets/img/favicon.png" style="height: 80px; width: auto"/>
          Selamat Datang di <strong>Kejaksaan Negeri Bengkulu</strong>. Silahkan pilih halaman yang ingin ditampilkan.
        </div>
      </div>
        ...
        <div class="col-lg-6 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-5">
              ...
              <p class="mb-4">Halaman Panggil Antrian Digunakan untuk Panggilan Antrian Yang Diperlihatkan Kepada Pengunjung.</p>
              <a href="panggil-antrian" class="btn btn-success rounded-pill px-4 py-2">
                Tampilkan <i class="bi-chevron-right ms-2"></i>
              </a>
            </div>
          </div>
